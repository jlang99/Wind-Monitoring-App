...
def get_wind_speed(state, county):
    ...
    global wind_speed1, wind_speed2, wind_speed3, gust_speed1, gust_speed2, gust_speed3
    ...
    content = soup.find('aside', class_='region-precis')
    info = content.find("dd")
    first= info.find("p")
...
def update_gui():
    mecklenburglblwind.config(text= "Wind: " + wind_speed_dict['mecklenburg'][0] + " | " + wind_speed_dict["mecklenburg"][1])
    mecklenburglblgust.config(text= "Gusts: " + wind_speed_dict['mecklenburg'][3] + " | " + wind_speed_dict["mecklenburg"][4])
    if int(wind_speed_dict["mecklenburg"][3]) >= 35 or int(wind_speed_dict["mecklenburg"][4]) >= 35 or int(wind_speed_dict["mecklenburg"][5]) >= 35:
        mecklenburg.config(bg='red')
        mecklenburglbl.config(bg='red')
        mecklenburglblgust.config(bg='red')
        mecklenburglblwind.config(bg='red')
    elif int(wind_speed_dict["mecklenburg"][0]) >= 30 or int(wind_speed_dict["mecklenburg"][1]) >= 30 or int(wind_speed_dict["mecklenburg"][2]) >= 30:
        mecklenburg.config(bg='red')
        mecklenburglbl.config(bg='red')
        mecklenburglblgust.config(bg='red')
        mecklenburglblwind.config(bg='red')
    elif (20 <= int(wind_speed_dict["mecklenburg"][0]) <= 25) or (20 <= int(wind_speed_dict["mecklenburg"][1]) <= 25) or (20 <= int(wind_speed_dict["mecklenburg"][2]) <= 25):
        mecklenburg.config(bg='orange')
        mecklenburglbl.config(bg='orange')
        mecklenburglblgust.config(bg='orange')
        mecklenburglblwind.config(bg='orange')
    else:
        mecklenburg.config(bg='green')
        mecklenburglbl.config(bg='green')
        mecklenburglblgust.config(bg='green')
        mecklenburglblwind.config(bg='green')
    ...
    if int(wind_speed_dict["lee"][3]) >= 35 or int(wind_speed_dict["lee"][4]) >= 35 or int(wind_speed_dict["lee"][5]) >= 35:
        lee.config(bg='red')
        leelbl.config(bg='red')
        leelblgust.config(bg='red')
        leelblwind.config(bg='red')
    elif int(wind_speed_dict["lee"][0]) >= 30 or int(wind_speed_dict["lee"][1]) >= 30 or int(wind_speed_dict["lee"][2]) >= 30:
        lee.config(bg='red')
        leelbl.config(bg='red')
        leelblgust.config(bg='red')
        leelblwind.config(bg='red')
    ...
    if int(wind_speed_dict["anderson"][3]) >= 35 or int(wind_speed_dict["anderson"][4]) >= 35 or int(wind_speed_dict["anderson"][5]) >= 35:
        anderson.config(bg='red')
        andersonlbl.config(bg='red')
        andersonlblgust.config(bg='red')
        andersonlblwind.config(bg='red')
    elif int(wind_speed_dict["anderson"][0]) >= 30 or int(wind_speed_dict["anderson"][1]) >= 30 or int(wind_speed_dict["anderson"][2]) >= 30:
        anderson.config(bg='red')
        andersonlbl.config(bg='red')
        andersonlblgust.config(bg='red')
        andersonlblwind.config(bg='red')
    ...
    if int(wind_speed_dict["bulloch"][3]) >= 35 or int(wind_speed_dict["bulloch"][4]) >= 35 or int(wind_speed_dict["bulloch"][5]) >= 35:
        bulloch.config(bg='red')
        bullochlbl.config(bg='red')
        bullochlblgust.config(bg='red')
        bullochlblwind.config(bg='red')
    elif int(wind_speed_dict["bulloch"][0]) >= 30 or int(wind_speed_dict["bulloch"][1]) >= 30 or int(wind_speed_dict["bulloch"][2]) >= 30:
        bulloch.config(bg='red')
        bullochlbl.config(bg='red')
        bullochlblgust.config(bg='red')
        bullochlblwind.config(bg='red')
    ...
    if int(wind_speed_dict["allendale"][3]) >= 35 or int(wind_speed_dict["allendale"][4]) >= 35 or int(wind_speed_dict["allendale"][5]) >= 35:
        allendale.config(bg='red')
        allendalelbl.config(bg='red')
        allendalelblgust.config(bg='red')
        allendalelblwind.config(bg='red')
    elif int(wind_speed_dict["allendale"][0]) >= 30 or int(wind_speed_dict["allendale"][1]) >= 30 or int(wind_speed_dict["allendale"][2]) >= 30:
        allendale.config(bg='red')
        allendalelbl.config(bg='red')
        allendalelblgust.config(bg='red')
        allendalelblwind.config(bg='red')
    ...
    if int(wind_speed_dict["williamsburg"][3]) >= 35 or int(wind_speed_dict["williamsburg"][4]) >= 35 or int(wind_speed_dict["williamsburg"][5]) >= 35:
    ...
    elif int(wind_speed_dict["williamsburg"][0]) >= 30 or int(wind_speed_dict["williamsburg"][1]) >= 30 or int(wind_speed_dict["williamsburg"][2]) >= 30:
        williamsburg.config(bg='red')
        williamsburglbl.config(bg='red')
        williamsburglblgust.config(bg='red')
        williamsburglblwind.config(bg='red')
    ...
    if int(wind_speed_dict["edgecombe"][3]) >= 35 or int(wind_speed_dict["edgecombe"][4]) >= 35 or int(wind_speed_dict["edgecombe"][5]) >= 35 or int(wind_speed_dict["edgecombe"][0]) >= 30 or int(wind_speed_dict["edgecombe"][1]) >= 30 or int(wind_speed_dict["edgecombe"][2]) >= 30:
    ...
    if int(wind_speed_dict["richmond"][3]) >= 35 or int(wind_speed_dict["richmond"][4]) >= 35 or int(wind_speed_dict["richmond"][5]) >= 35:
        richmond.config(bg='red')
        richmondlbl.config(bg='red')
        richmondlblgust.config(bg='red')
        richmondlblwind.config(bg='red')
    elif int(wind_speed_dict["richmond"][0]) >= 30 or int(wind_speed_dict["richmond"][1]) >= 30 or int(wind_speed_dict["richmond"][2]) >= 30:
        richmond.config(bg='red')
        richmondlbl.config(bg='red')
        richmondlblgust.config(bg='red')
        richmondlblwind.config(bg='red')
    ...
    if int(wind_speed_dict["upson"][3]) >= 35 or int(wind_speed_dict["upson"][4]) >= 35 or int(wind_speed_dict["upson"][5]) >= 35:
        upson.config(bg='red')
        upsonlbl.config(bg='red')
        upsonlblgust.config(bg='red')
        upsonlblwind.config(bg='red')
    elif int(wind_speed_dict["upson"][0]) >= 30 or int(wind_speed_dict["upson"][1]) >= 30 or int(wind_speed_dict["upson"][2]) >= 30:
        upson.config(bg='red')
        upsonlbl.config(bg='red')
        upsonlblgust.config(bg='red')
        upsonlblwind.config(bg='red')
    ...
    if int(wind_speed_dict["darlington"][3]) >= 35 or int(wind_speed_dict["darlington"][4]) >= 35 or int(wind_speed_dict["darlington"][5]) >= 35:
        darlington.config(bg='red')
        darlingtonlbl.config(bg='red')
        darlingtonlblgust.config(bg='red')
        darlingtonlblwind.config(bg='red')
    elif int(wind_speed_dict["darlington"][0]) >= 30 or int(wind_speed_dict["darlington"][1]) >= 30 or int(wind_speed_dict["darlington"][2]) >= 30:
        darlington.config(bg='red')
        darlingtonlbl.config(bg='red')
        darlingtonlblgust.config(bg='red')
        darlingtonlblwind.config(bg='red')
    ...
    if int(wind_speed_dict["dillon"][3]) >= 35 or int(wind_speed_dict["dillon"][4]) >= 35 or int(wind_speed_dict["dillon"][5]) >= 35:
        dillon.config(bg='red')
        dillonlbl.config(bg='red')
        dillonlblgust.config(bg='red')
        dillonlblwind.config(bg='red')
    elif int(wind_speed_dict["dillon"][0]) >= 30 or int(wind_speed_dict["dillon"][1]) >= 30 or int(wind_speed_dict["dillon"][2]) >= 30:
        dillon.config(bg='red')
        dillonlbl.config(bg='red')
        dillonlblgust.config(bg='red')
        dillonlblwind.config(bg='red')
    ...
    if int(wind_speed_dict["marion"][3]) >= 35 or int(wind_speed_dict["marion"][4]) >= 35 or int(wind_speed_dict["marion"][5]) >= 35:
        marion.config(bg='red')
        marionlbl.config(bg='red')
        marionlblgust.config(bg='red')
        marionlblwind.config(bg='red')
    elif int(wind_speed_dict["marion"][0]) >= 30 or int(wind_speed_dict["marion"][1]) >= 30 or int(wind_speed_dict["marion"][2]) >= 30:
        marion.config(bg='red')
        marionlbl.config(bg='red')
        marionlblgust.config(bg='red')
        marionlblwind.config(bg='red')
    ...
    if int(wind_speed_dict["chesterfield"][3]) >= 35 or int(wind_speed_dict["chesterfield"][4]) >= 35 or int(wind_speed_dict["chesterfield"][5]) >= 35:
    ...
    elif int(wind_speed_dict["chesterfield"][0]) >= 30 or int(wind_speed_dict["chesterfield"][1]) >= 30 or int(wind_speed_dict["chesterfield"][2]) >= 30:
        chesterfield.config(bg='red')
        chesterfieldlbl.config(bg='red')
        chesterfieldlblgust.config(bg='red')
        chesterfieldlblwind.config(bg='red')
    ...
    if int(wind_speed_dict["marlboro"][3]) >= 35 or int(wind_speed_dict["marlboro"][4]) >= 35 or int(wind_speed_dict["marlboro"][5]) >= 35:
        marlboro.config(bg='red')
        marlborolbl.config(bg='red')
        marlborolblgust.config(bg='red')
        marlborolblwind.config(bg='red')
    elif int(wind_speed_dict["marlboro"][0]) >= 30 or int(wind_speed_dict["marlboro"][1]) >= 30 or int(wind_speed_dict["marlboro"][2]) >= 30:
        marlboro.config(bg='red')
        marlborolbl.config(bg='red')
        marlborolblgust.config(bg='red')
        marlborolblwind.config(bg='red')
    ...
    clevelandlblwind.config(text= "Wind: " + wind_speed_dict['cleveland'][0] + " | " + wind_speed_dict["cleveland"][1] + " | " + wind_speed_dict["cleveland"][2])
    clevelandlblgust.config(text= "Gusts: " + wind_speed_dict['cleveland'][3] + " | " + wind_speed_dict["cleveland"][4] + " | " + wind_speed_dict["cleveland"][5])
    if int(wind_speed_dict["cleveland"][3]) >= 35 or int(wind_speed_dict["cleveland"][4]) >= 35 or int(wind_speed_dict["cleveland"][5]) >= 35:
        cleveland.config(bg='red')
        clevelandlbl.config(bg='red')
        clevelandlblgust.config(bg='red')
        clevelandlblwind.config(bg='red')
    elif int(wind_speed_dict["cleveland"][0]) >= 30 or int(wind_speed_dict["cleveland"][1]) >= 30 or int(wind_speed_dict["cleveland"][2]) >= 30:
        cleveland.config(bg='red')
        clevelandlbl.config(bg='red')
        clevelandlblgust.config(bg='red')
        clevelandlblwind.config(bg='red')
    elif (20 <= int(wind_speed_dict["cleveland"][0]) <= 25) or (20 <= int(wind_speed_dict["cleveland"][1]) <= 25) or (20 <= int(wind_speed_dict["cleveland"][2]) <= 25):
        cleveland.config(bg='orange')
        clevelandlbl.config(bg='orange')
        clevelandlblgust.config(bg='orange')
        clevelandlblwind.config(bg='orange')
    else:
        cleveland.config(bg='green')
        clevelandlbl.config(bg='green')
        clevelandlblgust.config(bg='green')
        clevelandlblwind.config(bg='green')
    ...
    if int(wind_speed_dict["surry"][3]) >= 35 or int(wind_speed_dict["surry"][4]) >= 35 or int(wind_speed_dict["surry"][5]) >= 35:
        surry.config(bg='red')
        surrylbl.config(bg='red')
        surrylblgust.config(bg='red')
        surrylblwind.config(bg='red')
    elif int(wind_speed_dict["surry"][0]) >= 30 or int(wind_speed_dict["surry"][1]) >= 30 or int(wind_speed_dict["surry"][2]) >= 30:
        surry.config(bg='red')
        surrylbl.config(bg='red')
        surrylblgust.config(bg='red')
        surrylblwind.config(bg='red')
    ...
    if int(wind_speed_dict["guilford"][3]) >= 35 or int(wind_speed_dict["guilford"][4]) >= 35 or int(wind_speed_dict["guilford"][5]) >= 35:
        guilford.config(bg='red')
        guilfordlbl.config(bg='red')
        guilfordlblgust.config(bg='red')
        guilfordlblwind.config(bg='red')
    elif int(wind_speed_dict["guilford"][0]) >= 30 or int(wind_speed_dict["guilford"][1]) >= 30 or int(wind_speed_dict["guilford"][2]) >= 30:
        guilford.config(bg='red')
        guilfordlbl.config(bg='red')
        guilfordlblgust.config(bg='red')
        guilfordlblwind.config(bg='red')
    ...
    cabarruslblwind.config(text= "Wind: " + wind_speed_dict['cabarrus'][0] + " | " + wind_speed_dict["cabarrus"][1] + " | " + wind_speed_dict["cabarrus"][2])
    cabarruslblgust.config(text= "Gusts: " + wind_speed_dict['cabarrus'][3] + " | " + wind_speed_dict["cabarrus"][4] + " | " + wind_speed_dict["cabarrus"][5])
    if int(wind_speed_dict["cabarrus"][3]) >= 35 or int(wind_speed_dict["cabarrus"][4]) >= 35 or int(wind_speed_dict["cabarrus"][5]) >= 35:
        cabarrus.config(bg='red')
        cabarruslbl.config(bg='red')
        cabarruslblgust.config(bg='red')
        cabarruslblwind.config(bg='red')
    elif int(wind_speed_dict["cabarrus"][0]) >= 30 or int(wind_speed_dict["cabarrus"][1]) >= 30 or int(wind_speed_dict["cabarrus"][2]) >= 30:
        cabarrus.config(bg='red')
        cabarruslbl.config(bg='red')
        cabarruslblgust.config(bg='red')
        cabarruslblwind.config(bg='red')
    elif (20 <= int(wind_speed_dict["cabarrus"][0]) <= 25) or (20 <= int(wind_speed_dict["cabarrus"][1]) <= 25) or (20 <= int(wind_speed_dict["cabarrus"][2]) <= 25):
        cabarrus.config(bg='orange')
        cabarruslbl.config(bg='orange')
        cabarruslblgust.config(bg='orange')
        cabarruslblwind.config(bg='orange')
    else:
        cabarrus.config(bg='green')
        cabarruslbl.config(bg='green')
        cabarruslblgust.config(bg='green')
        cabarruslblwind.config(bg='green')
    ...
    if int(wind_speed_dict["randolph"][3]) >= 35 or int(wind_speed_dict["randolph"][4]) >= 35 or int(wind_speed_dict["randolph"][5]) >= 35:
        randolph.config(bg='red')
        randolphlbl.config(bg='red')
        randolphlblgust.config(bg='red')
        randolphlblwind.config(bg='red')
    elif int(wind_speed_dict["randolph"][0]) >= 30 or int(wind_speed_dict["randolph"][1]) >= 30 or int(wind_speed_dict["randolph"][2]) >= 30:
        randolph.config(bg='red')
        randolphlbl.config(bg='red')
        randolphlblgust.config(bg='red')
        randolphlblwind.config(bg='red')
    ...
    if int(wind_speed_dict["hoke"][3]) >= 35 or int(wind_speed_dict["hoke"][4]) >= 35 or int(wind_speed_dict["hoke"][5]) >= 35:
        hoke.config(bg='red')
        hokelbl.config(bg='red')
        hokelblgust.config(bg='red')
        hokelblwind.config(bg='red')
    elif int(wind_speed_dict["hoke"][0]) >= 30 or int(wind_speed_dict["hoke"][1]) >= 30 or int(wind_speed_dict["hoke"][2]) >= 30:
        hoke.config(bg='red')
        hokelbl.config(bg='red')
        hokelblgust.config(bg='red')
        hokelblwind.config(bg='red')
    ...
    if int(wind_speed_dict["robeson"][3]) >= 35 or int(wind_speed_dict["robeson"][4]) >= 35 or int(wind_speed_dict["robeson"][5]) >= 35:
        robeson.config(bg='red')
        robesonlbl.config(bg='red')
        robesonlblgust.config(bg='red')
        robesonlblwind.config(bg='red')
    elif int(wind_speed_dict["robeson"][0]) >= 30 or int(wind_speed_dict["robeson"][1]) >= 30 or int(wind_speed_dict["robeson"][2]) >= 30:
        robeson.config(bg='red')
        robesonlbl.config(bg='red')
        robesonlblgust.config(bg='red')
        robesonlblwind.config(bg='red')
    ...
    if int(wind_speed_dict["scotland"][3]) >= 35 or int(wind_speed_dict["scotland"][4]) >= 35 or int(wind_speed_dict["scotland"][5]) >= 35:
        scotland.config(bg='red')
        scotlandlbl.config(bg='red')
        scotlandlblgust.config(bg='red')
        scotlandlblwind.config(bg='red')
    elif int(wind_speed_dict["scotland"][0]) >= 30 or int(wind_speed_dict["scotland"][1]) >= 30 or int(wind_speed_dict["scotland"][2]) >= 30:
        scotland.config(bg='red')
        scotlandlbl.config(bg='red')
        scotlandlblgust.config(bg='red')
        scotlandlblwind.config(bg='red')
    ...
    if int(wind_speed_dict["sampson"][3]) >= 35 or int(wind_speed_dict["sampson"][4]) >= 35 or int(wind_speed_dict["sampson"][5]) >= 35:
        sampson.config(bg='red')
        sampsonlbl.config(bg='red')
        sampsonlblgust.config(bg='red')
        sampsonlblwind.config(bg='red')
    elif int(wind_speed_dict["sampson"][0]) >= 30 or int(wind_speed_dict["sampson"][1]) >= 30 or int(wind_speed_dict["sampson"][2]) >= 30:
        sampson.config(bg='red')
        sampsonlbl.config(bg='red')
        sampsonlblgust.config(bg='red')
        sampsonlblwind.config(bg='red')
    ...
    if int(wind_speed_dict["duplin"][3]) >= 35 or int(wind_speed_dict["duplin"][4]) >= 35 or int(wind_speed_dict["duplin"][5]) >= 35:
        duplin.config(bg='red')
        duplinlbl.config(bg='red')
        duplinlblgust.config(bg='red')
        duplinlblwind.config(bg='red')
    elif int(wind_speed_dict["duplin"][0]) >= 30 or int(wind_speed_dict["duplin"][1]) >= 30 or int(wind_speed_dict["duplin"][2]) >= 30:
        duplin.config(bg='red')
        duplinlbl.config(bg='red')
        duplinlblgust.config(bg='red')
        duplinlblwind.config(bg='red')
    ...
    if int(wind_speed_dict["lenoir"][3]) >= 35 or int(wind_speed_dict["lenoir"][4]) >= 35 or int(wind_speed_dict["lenoir"][5]) >= 35:
        lenoir.config(bg='red')
        lenoirlbl.config(bg='red')
        lenoirlblgust.config(bg='red')
        lenoirlblwind.config(bg='red')
    elif int(wind_speed_dict["lenoir"][0]) >= 30 or int(wind_speed_dict["lenoir"][1]) >= 30 or int(wind_speed_dict["lenoir"][2]) >= 30:
        lenoir.config(bg='red')
        lenoirlbl.config(bg='red')
        lenoirlblgust.config(bg='red')
        lenoirlblwind.config(bg='red')
    ...
    if int(wind_speed_dict["wayne"][3]) >= 35 or int(wind_speed_dict["wayne"][4]) >= 35 or int(wind_speed_dict["wayne"][5]) >= 35:
        wayne.config(bg='red')
        waynelbl.config(bg='red')
        waynelblgust.config(bg='red')
        waynelblwind.config(bg='red')
    elif int(wind_speed_dict["wayne"][0]) >= 30 or int(wind_speed_dict["wayne"][1]) >= 30 or int(wind_speed_dict["wayne"][2]) >= 30:
        wayne.config(bg='red')
        waynelbl.config(bg='red')
        waynelblgust.config(bg='red')
        waynelblwind.config(bg='red')
    ...
    if int(wind_speed_dict["greene"][3]) >= 35 or int(wind_speed_dict["greene"][4]) >= 35 or int(wind_speed_dict["greene"][5]) >= 35:
        greene.config(bg='red')
        greenelbl.config(bg='red')
        greenelblgust.config(bg='red')
        greenelblwind.config(bg='red')
    elif int(wind_speed_dict["greene"][0]) >= 30 or int(wind_speed_dict["greene"][1]) >= 30 or int(wind_speed_dict["greene"][2]) >= 30:
        greene.config(bg='red')
        greenelbl.config(bg='red')
        greenelblgust.config(bg='red')
        greenelblwind.config(bg='red')
...
root.iconbitmap(r"G:\Shared drives\O&M\NCC Automations\Notification System\Wind.ico")

image_map = Image.open(r"G:\Shared drives\O&M\NCC Automations\Notification System\NC, SC, GA Map.jpg").resize((1920, 1080))
...
mecklenburg = LabelFrame(root)
mecklenburg.place(x=850, y=220)
mecklenburglbl = Label(mecklenburg, text= "Mecklenburg")
mecklenburglbl.grid(column=0, row= 0, columnspan= 3)
mecklenburglblwind = Label(mecklenburg, text= "Wind: ")
mecklenburglblwind.grid(column=0, row=1)
mecklenburglblgust = Label(mecklenburg, text= "Gusts: ")
mecklenburglblgust.grid(column= 0, row= 2)
...
cleveland = LabelFrame(root)
cleveland.place(x=750, y=220)
clevelandlbl = Label(cleveland, text= "Cleveland")
clevelandlbl.grid(column=0, row= 0, columnspan= 3)
clevelandlblwind = Label(cleveland, text= "Wind: ")
clevelandlblwind.grid(column=0, row=1)
clevelandlblgust = Label(cleveland, text= "Gusts: ")
clevelandlblgust.grid(column= 0, row= 2)

cabarrus = LabelFrame(root)
cabarrus.place(x=950, y=200)
cabarruslbl = Label(cabarrus, text= "Cabarrus")
cabarruslbl.grid(column=0, row= 0, columnspan= 3)
cabarruslblwind = Label(cabarrus, text= "Wind: ")
cabarruslblwind.grid(column=0, row=1)
cabarruslblgust = Label(cabarrus, text= "Gusts: ")
cabarruslblgust.grid(column= 0, row= 2)
...
sites_in_sampson = Label(legend, text="Sampson: Harrison, Van Buren")
...
sites_in_cabarrus.pack(anchor=W)
